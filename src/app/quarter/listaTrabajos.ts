...
export class ListaTrabajos {
  ...
  constructor(private army: ArmyService, private meat: MeatService, private gold: GoldService) {
    this.trabajos.push(
      ...
      new Job(3, 'Caballeria Ligera', 1, [7, 10, 15, 17, 20], 45, [10, 15, 20, 25, 30], [10, 15, 20, 25, 30], [250, 260, 270, 280, 290]),
      new Job(4, 'Caballeria Pesada', 1, [15, 20, 24, 27, 30], 70, [15, 20, 25, 30, 35], [15, 20, 25, 30, 35], [300, 310, 320, 330, 340]),
